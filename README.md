...
- 공공데이터포털 (`data_go_kr_key`): Needed for the apartment-market and weather lines. Register at [data.go.kr](https://www.data.go.kr/); the account gets ONE key, but each API needs its own 활용신청 (instant, 자동승인) before the key works against it — apply for 아파트 매매 실거래가 (15126469), 아파트 전월세 실거래가 (15126474), 지상(종관, ASOS) 일자료 (15059093), 전국공항 수송실적통계 (15158834), 질병정보서비스 (15119055), 전국문화기반시설총람 (15125097) and 관광자원통계서비스 (15000366 — its openapi.tour.go.kr gateway can take overnight to register a new key). Without this key the bot still runs; those lines simply don't appear.
